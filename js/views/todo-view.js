...
(function ($) {
	...
	app.TodoView = Backbone.View.extend({
		...
		events: {
			...
			'click .secondary-btn': 'toggleSecondary',
		...
		render: function () {
			...
			this.$el.toggleClass('secondary', this.model.get('secondary'));
			this.toggleVisible();
		...
		// Toggle the `"secondary"` state of the model.
		toggleSecondary: function () {
			this.model.toggleSecondary();
		},
